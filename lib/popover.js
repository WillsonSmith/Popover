...
/***/ function(module, exports) {
	...
	var Popover = function () {
	  function Popover(node, focusableElements) {
	    var _this = this;
	  ...
	  _createClass(Popover, [{
	    ...
	    value: function _tabEventHandler(evt, focusNode) {
	      ...
	      if (evt.keyCode === 9 && this.shiftDown) {
	        var activatorIndex = this.focusableElements.indexOf(this.activator);
	        var prevIndex = activatorIndex - 1 >= 0 ? activatorIndex - 1 : this.focusableElements.length - 1;
	        this.deactivatePopover();
